...
FOLDS=(2) # In different files: 1, 2, 3
MOIS_SAM_AGGREGATE_EXEMPLARS_VALIDATION="aggregate_exemplars"
NUM_LESIONS_AND_EXEMPLARS=(8 10) # Should be equal to the number of exemplars
