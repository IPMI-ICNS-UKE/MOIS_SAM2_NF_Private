...
EVAL_MODE="global_non_corrective"
...
for TEST_SET_ID in "${TEST_SET_IDS[@]}"; do
    ...
    python ../pipelines/evaluation_pipeline.py --network_type $NETWORK --fold $FOLD --use_automatic_vista_inference $AUTOMATIC_INFERENCE --evaluation_mode $EVAL_MODE  --num_interactions_per_lesion $NUM_INTERACTIONS_PER_LESION --test_set_id $TEST_SET_ID --save_predictions --use_gpu
done
